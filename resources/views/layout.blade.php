      ...
      <div class="ui inverted menu main-nav">
        ...
        <div class="right menu">
          ...
          <div class="ui pointing dropdown link item " style="z-index: 600 !important;">
            <i class="large send icon"></i>ดาวเทียม
          ...
          <div class="ui pointing dropdown link item " style="z-index: 600 !important;">
            <i class="large inverted archive icon"></i>คลังข้อมูล
            <i class="dropdown icon"></i>
            <div class="menu">
              ...
              <a class="item" href="{{ route('Project.logCollection') }}">
                <i class="list layout icon"></i>ประวัติการรับสัญาณ</a>
          ...
          <div class="ui pointing dropdown link item " style="z-index: 600 !important;">
            <i class="large settings icon"></i>จัดการระบบ
            <i class="dropdown icon"></i>
            <div class="menu">
          ...
          <div class="ui pointing dropdown link item " style="z-index: 600 !important;">
            <i class="large inverted blue user circle outline icon"></i>{{ Auth::user()->name }}
            <i class="dropdown icon"></i>
            <div class="menu">

              <a class="item editProfilelogin" data-id="{{ Auth::user()->id }}" data-name="{{ Auth::user()->name }}" data-email="{{ Auth::user()->email }}"
                data-phonenumber="{{ Auth::user()->PhoneNumber }}">
                <i class="edit icon"></i>แก้ไขข้อมูลส่วนตัว</a>
              <a class="item" id="editpassword">
                <i class="settings icon"></i>เปลี่ยนPassword</a>
              <a class="item" href="" download='guideadmin.pdf'>
                <i class="warning sign icon"></i>คู่มือแนะนำการใช้เว็ปไซต์</a>
              <a class="item" href="{{ route('Project.logout') }}">
                <i class="sign out icon"></i>ออกจากระบบ</a>
            </div>
          </div>


          @endif @if(Auth::check()==false)
      ...
      <div class="ui bottom attached segment pushable">
        <div class="ui inverted labeled  vertical sidebar menu">
          <a href="{{ route('Project.dashboard') }}">
            <div class="navbar-header">
              <center>
                <img src="{{ asset('photo/gistdalogoMain.png') }}" class="photologo2">
              </center>
            </div>
          </a>

          <div class="ui item ">
            <div class="text " id="hideShowSatellite">
              <i class="large send icon"></i>ดาวเทียม</div>
            <div class="menu">
          ...
          <div class="ui item ">
            <div class="text " id="hideShowphoto">
              <i class="large archive icon"></i>คลังข้อมูล</div>
            <div class="menu">
              <div id="hidePhoto">
                <a class="item" href="{{ route('Project.PhotoGallery') }}">
          ...
          <div class="ui item">
            <div class="text" id="hideShowSetting">
              <i class="large settings icon"></i>จัดการระบบ
            </div>
            <div class="menu">
              <div id="hideSetting">
          ...
          @endif @if(Auth::check())
          <div class="ui item">
            <div class="text" id="hideShowProfile">
              <i class="large address card outline icon"></i>{{ Auth::user()->name }}</div>
            ...
            <div class="menu">
              <div id="hideProfile">
                ...
                <a class="item" id="editpassword">
                  <i class="settings icon"></i>เปลี่ยนPassword</a>
                <a class="item" href="/admin/guideadmin.pdf" download='guideadmin.pdf'>
                  <i class="warning sign icon"></i>คู่มือแนะนำการใช้เว็ปไซต์</a>
                <a class="item" href="{{ route('Project.logout') }}">
                  <i class="sign out icon"></i>ออกจากระบบ</a>
              </div>
